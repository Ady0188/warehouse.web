...
internal class OperationDbContext : DbContext
{
    private readonly IDomainEventDispatcher _dispatcher;
    public OperationDbContext(DbContextOptions<OperationDbContext> options, IDomainEventDispatcher dispatcher) : base(options)
    {
